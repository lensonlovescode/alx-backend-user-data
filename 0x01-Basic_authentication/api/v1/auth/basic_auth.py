...
class BasicAuth(Auth):
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        ...
        base64 = self.extract_base64_authorization_header(author)
        decoded_str = self.decode_base64_authorization_header(base64)
        cred = self.extract_user_credentials(decoded_str)
